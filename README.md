# SAMANI CREATIONS Invoicing System

A fully functional, professional web platform for generating quotes, invoices, and receipts for SAMANI CREATIONS LTD.

## Features
*   Create Quotes, Invoices, and Receipts with auto-calculated totals.
*   Generate professional PDF documents.
*   Email approval workflow for invoices and quotes.
*   Client management and business reporting.
